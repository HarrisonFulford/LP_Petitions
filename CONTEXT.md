...
Use `README.md` as the public source of truth for project goals and specifications. Use `contract.md` and `fullstack.md` for the current priorities. Use `ChangeLog.md` to log changes to originial `implementation_plan.md` or `README.md` **After every approved, holistic change, ensure you've synced the docs**
